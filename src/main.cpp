...
int main(int argc, char ** argv)
{
    ...
    cout << endl;
    cout << "3 - Logo após deve-se decidir o Modo de jogo. " << endl;
    cout << endl;
    cout << "3.1 - Gosper glider gun. " << endl;
    cout << endl;
    cout << "3.2 - Campo livre. " << endl;
    cout << endl;
    cout << "3.3 - Block. " << endl;
    cout << endl;
    cout << "3.4 - Blinker. " << endl;
    cout << endl;
    cout << "3.5 - Glider. " << endl;
    cout << endl;
    cout << "4 - O campo padrão e composto por 40 linhas e 60 colunas." << endl;
    cout << endl;
    cout << "5 - No caso de Campo Personalizado no modo Glider gun o campo deve ter no minimo 40 linhas e 40 colunas." << endl;
    cout << endl;
    cout << "6 - Sera perguntado o número de geraçoes desejadas" << endl;
    cout << endl;
    cout << "7- Chegando na geração final aperte \"0\" para parar, ou \"1\" para mais Geraçoes." << endl;
    cout << endl;
    cout << "8- Ao fim o jogo e finalizado." << endl;
    cout << endl;
    cout << endl;
    cout <<" Bom Jogo !!" << endl;
    cout << endl;
